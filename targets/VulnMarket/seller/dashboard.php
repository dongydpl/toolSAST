...
<body>
    ...
    <?php if (isset($_GET['msg']) && $_GET['msg'] == 'edited') echo "<p style='color:green;'>Sửa sản phẩm thành công!</p>"; ?>
    ...
    <table>
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><a href='edit_product.php?id=" . $row['id'] . "'><button>Edit</button></a> <a href='delete_product.php?id=" . $row['id'] . "'><button>Delete</button></a></td>";
                echo "</tr>";
            }
        } else {
